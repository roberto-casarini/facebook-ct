    ...
    <div class="bg-white rounded shadow w-2/3 p-4">
        <div class="flex justify-between items-center">
            ...
            <div class="flex-1 mx-4">
                <input type="text" name="body" class="w-full pl-4 h-8 bg-gray-200 rounded-full bg-gray-200 focus:outline-none focus:shadow-outline text-sm" placeholder="Add a post">
            </div>
            <div>
