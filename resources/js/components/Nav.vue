    ...
    <div class="bg-white h-12 px-4 flex items-center border-b border-gray-400 shadow-sm">
        <div class="w-1/3">
            <div class="flex">
                ...
                <div class="ml-2 relative">
                    <div class="absolute text-gray-500 hover:text-gray-700">
                    ...
                    <input type="text" name="search" class="rounded-full pl-8 w-48 bg-gray-200 h-8 focus:outline-none focus:shadow-outline text-sm" placeholder="Search Facebook">
                </div>
            </div>
        </div>
        <div class="w-1/3 flex justify-center items-center h-full">
            ...
            <router-link to="/" class="px-6 border-b-2 border-white h-full flex items-center">
                <img src="https://assetsds.cdnedge.bluemix.net/sites/default/files/styles/big_6/public/news/images/barguna_rifak_sharif.jpg?itok=XJFX5EBT" alt="profile image for user" class="w-8 h-8 object-cover rounded-full">
            </router-link>
            <router-link to="/" class="px-6 border-b-2 border-white h-full flex items-center">
